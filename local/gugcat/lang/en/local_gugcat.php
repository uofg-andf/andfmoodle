...
$string['continuedisplay'] = 'Continue to display original assessment details on Course Grade Aggregation tool?';
$string['coursegradeaggregation'] = 'Course Grade Aggregation';
$string['coursegradehistory'] = 'Course Grade History';
$string['display'] = 'Display:';
$string['displaybestgrade'] = 'Display best grade:';
$string['downloadcsv'] = 'Download .csv';
$string['enteraggrename'] = 'Enter Aggregation Name:';
...
$string['selectassessmentscompare'] = 'Select assessments to compare:';
$string['selectgradesaggregate'] = 'Select grades to aggregate:';
$string['selectreason'] = 'Select reason';
$string['setupaggrecalc'] = 'Set up grade aggregation calculation - Course Aggregation';
$string['setupcustomgradefield'] = 'Set up custom grade field - Assessment Aggregation';
