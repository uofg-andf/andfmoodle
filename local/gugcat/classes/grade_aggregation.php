...
class grade_aggregation{
    ...
    public static function release_final_grades($courseid){
        ...
        $students = get_enrolled_users(context_course ::instance($courseid), 'local/gugcat:gradeable', 0, 'u.id');
    ...
    public static function export_aggregation_tool($course){
        ...
        $students = get_enrolled_users(context_course::instance($course->id), 'local/gugcat:gradeable');
